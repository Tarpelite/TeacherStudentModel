...
from pytorch_pretrained_bert.modeling import BertConfig, WEIGHTS_NAME, CONFIG_NAME, BertForSequenceClassification, BertForSequenceClassification, BertPreTrainedModel, BertModel
